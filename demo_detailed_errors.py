...
def main():
    ...
    print("\nBefore this change:")
    print("  - MQTT status only showed generic error: 'Error shortening event name: Test Event'")
    print("\nAfter this change:")
    print("  - MQTT status shows specific errors like:")
    print("    • 'AI shortening failed for 'Test Event': AI shortener enabled but no API key provided'")
    print("    • 'AI shortening failed for 'Rugby Match': google.generativeai library not available'")
    print("    • 'AI shortening failed for 'Event Name': Generated name exceeds visual width limit'")
