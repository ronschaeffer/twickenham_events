...
from core.twick_event import process_and_publish_events, error_log
...
def demonstrate_mqtt_status_integration():
    ...
    _, had_error, error_message = get_short_name(
        "Test Rugby Match", config_with_error)
    if had_error:
        error_log.append(
...
if __name__ == "__main__":
    ...
    print("- Specific error reasons (missing API key, missing prompt, API failures, etc.)")
