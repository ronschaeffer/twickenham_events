...
class TestEventShortener(unittest.TestCase):
    ...
    def test_successful_api_response(self, mock_sleep, mock_genai, mock_save_cache, mock_load_cache):
    ...
    @patch('core.event_shortener.genai')
    @patch('time.sleep')  # Mock sleep to speed up tests
    def test_empty_api_response_returns_error(self, mock_sleep, mock_genai, mock_save_cache, mock_load_cache):
    ...
    @patch('core.event_shortener.genai')
    @patch('time.sleep')  # Mock sleep to speed up tests
    def test_overlength_response_returns_error(self, mock_sleep, mock_genai, mock_save_cache, mock_load_cache):
    ...
    @patch('core.event_shortener.genai')
    @patch('time.sleep')  # Mock sleep to speed up tests
    def test_prompt_formatting(self, mock_sleep, mock_genai, mock_save_cache, mock_load_cache):
