...
class TestEventShortenerNewFeatures(unittest.TestCase):
    ...
    def test_environment_variable_expansion(self):
        ...
        with (
            ...
            mock_genai.configure.assert_called_once_with(api_key="actual_api_key")
    ...
    def test_flag_standardization_applied(
        self, mock_sleep, mock_genai, mock_save_cache, mock_load_cache
    ):
    ...
    # Set environment variable
    @patch.dict(os.environ, {"GEMINI_API_KEY": "test_api_key"})
    def test_visual_width_validation(
        self, mock_sleep, mock_genai, mock_save_cache, mock_load_cache
    ):
    ...
    def test_new_config_keys_used(self):
        ...
        original_name = "Test Event"
        result, had_error, error_message = get_short_name(original_name, config)
    ...
    # Set environment variable
    @patch.dict(os.environ, {"GEMINI_API_KEY": "test_api_key"})
    def test_prompt_includes_flag_instructions(
        self, mock_genai, mock_save_cache, mock_load_cache
    ):
    ...
    @patch("core.event_shortener.save_cache")
    @patch("core.event_shortener.genai")
    def test_prompt_excludes_flags_when_disabled(
        self, mock_genai, mock_save_cache, mock_load_cache
    ):
        ...
        original_name = "Argentina vs South Africa"
        _, _, _ = get_short_name(original_name, self.test_config_flags_disabled)
